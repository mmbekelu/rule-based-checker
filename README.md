...
This program checks a structured request and decides whether it is ALLOWED or BLOCKED
using clear, deterministic rules.
...
This checker blocks unsafe or invalid requests before they reach AI
or downstream logic.
